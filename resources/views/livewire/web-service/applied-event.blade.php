<div class="pb-8">
    <div class="container mx-auto flex flex-wrap mt-2 xl:px-24 px-4">
        <p class="text-xl pt-8 pl-4 w-full font-semibold">Upcoming Events</p>
        @if($event_list == null)
            <x-wireui-alert class="mt-2" title="No upcoming events."/>
        @else
    ...
    <div class="container mx-auto flex flex-wrap mt-2 xl:px-24 px-4">
        <p class="text-xl pt-8 pl-4 w-full font-semibold">Past Events</p>
        @if($past_events == null)
            <x-wireui-alert class="mt-2" title="No past events."/>
        @else
